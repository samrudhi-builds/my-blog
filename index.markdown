  ...
  <div class="container">
    ...
    <div class="hero-stats">
      ...
      <div class="stat">
        ...
        <div class="stat-label">Springer Paper</div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div style="margin-bottom:2.5rem;">
      ...
      <div class="cards-grid">
        ...
        <div class="card">
          ...
          <p>Smart ticketing system using OCR, ML, liveness checks, and chatbot integration for enhanced user verification.</p>
          <div class="tags"><span class="tag">OCR</span><span class="tag">ML</span><span class="tag">Chatbot</span><span class="tag">Computer Vision</span></div>
        </div>
      </div>
    </div>
    ...
    <div style="margin-bottom:2.5rem;">
      ...
      <div class="cards-grid">
        ...
        <div class="card">
          <div class="card-header"><h3>Blockchain Voting System</h3><span class="card-badge ongoing">Ongoing</span></div>
          <p>Decentralized voting platform for Indian elections with enhanced security and transparency via smart contracts.</p>
          <div class="tags"><span class="tag">Blockchain</span><span class="tag">Smart Contracts</span><span class="tag">Security</span></div>
        </div>
        <div class="card">
...
<section class="section" id="experience">
  <div class="container">
    <div class="section-header">
      ...
      <p class="section-sub">7+ internships across cybersecurity, blockchain, ML, and full-stack</p>
    </div>
    <div class="timeline">
      <div class="timeline-item">
        ...
        <div class="tags" style="margin-top:0.6rem;"><span class="tag">Full-Stack</span><span class="tag">System Design</span><span class="tag">Technical Docs</span></div>
      </div>
      <div class="timeline-item">
        ...
        <div class="tags" style="margin-top:0.6rem;"><span class="tag">Leadership</span><span class="tag">Digital Governance</span><span class="tag">Stakeholder Mgmt</span></div>
      </div>
      <div class="timeline-item">
        ...
        <div class="tags" style="margin-top:0.6rem;"><span class="tag">Python</span><span class="tag">ML</span><span class="tag">Predictive Modeling</span><span class="tag">EDA</span></div>
      </div>
      <div class="timeline-item">
      ...
      <div class="timeline-item">
        ...
        <div class="tags" style="margin-top:0.6rem;"><span class="tag">Python</span><span class="tag">MySQL</span><span class="tag">Data Visualization</span></div>
      </div>
      <div class="timeline-item">
        ...
        <div class="tags" style="margin-top:0.6rem;"><span class="tag">EdTech</span><span class="tag">Algorithm Visualization</span></div>
      </div>
      <div class="timeline-item">
        ...
        <div class="tags" style="margin-top:0.6rem;"><span class="tag">ML Research</span><span class="tag">Web Development</span><span class="tag">UI/UX</span></div>
      </div>
    </div>
  </div>
</section>
...
<section class="section" id="certifications">
  <div class="container">
    ...
    <div class="certs-section">
      ...
      <div class="certs-grid">
        <div class="cert-card"><div class="cert-issuer">KJSCE</div><div class="cert-name">Blockchain Technology: Innovation for Next Web 3</div></div>
        <div class="cert-card"><div class="cert-issuer">Professional</div><div class="cert-name">Blockchain Basics</div></div>
      </div>
    </div>

    <div class="certs-section">
      <h2>Data Science &amp; Programming</h2>
      <div class="certs-grid">
        <div class="cert-card"><div class="cert-issuer">Google</div><div class="cert-name">Data Analysis with R Programming</div></div>
        <div class="cert-card"><div class="cert-issuer">Duke University (Coursera)</div><div class="cert-name">Java Programming: Solving Problems with Software</div></div>
        <div class="cert-card"><div class="cert-issuer">Duke University (Coursera)</div><div class="cert-name">Java Programming: Arrays, Lists, and Structured Data</div></div>
        <div class="cert-card"><div class="cert-issuer">ULSA</div><div class="cert-name">Getting Started with Go</div></div>
        <div class="cert-card"><div class="cert-issuer">Meta</div><div class="cert-name">Version Control</div></div>
      </div>
    </div>
    ...
    <div class="certs-section">
      ...
      <div class="certs-grid">
        <div class="cert-card"><div class="cert-issuer">Coursera</div><div class="cert-name">UI/UX Design Specialization</div></div>
        <div class="cert-card"><div class="cert-issuer">Google</div><div class="cert-name">Foundations of Project Management</div></div>
        <div class="cert-card"><div class="cert-issuer">Google</div><div class="cert-name">Project Initiation: Starting a Successful Project</div></div>
        <div class="cert-card"><div class="cert-issuer">University of Virginia</div><div class="cert-name">Financial Accounting Fundamentals</div></div>
      </div>
    </div>
...
<section class="section" id="blog">
  <div class="container">
    <div class="section-header">
      ...
      <p class="section-sub">Technical deep dives, internship stories, and lessons learned</p>
    </div>
    ...
    <div class="posts-list">
      ...
      <div class="post-item">
        ...
        <div>
          ...
          {% if post.description %}<p class="post-excerpt">{{ post.description }}</p>
          {% elsif post.excerpt %}<p class="post-excerpt">{{ post.excerpt | strip_html | truncate: 130 }}</p>{% endif %}
        </div>
      </div>
      {% endfor %}
    </div>
...
<section class="section" id="contact">
  <div class="container">
    <div class="section-header">
      ...
      <p class="section-sub">Open to collaborations, research, and interesting problems.</p>
    </div>
    <div class="contact-grid">
      <div class="contact-item">
        <div class="contact-label">Email</div>
        <a href="mailto:samrudhib24@gmail.com" class="contact-value">samrudhib24@gmail.com</a>
      </div>
      <div class="contact-item">
        <div class="contact-label">LinkedIn</div>
        <a href="https://linkedin.com/in/samrudhi-b-4564a1258" class="contact-value" target="_blank" rel="noopener">samrudhi-b-4564a1258</a>
      </div>
      <div class="contact-item">
        <div class="contact-label">GitHub</div>
        <a href="https://github.com/samrudhi-builds" class="contact-value" target="_blank" rel="noopener">@samrudhi-builds</a>
      </div>
      <div class="contact-item">
        <div class="contact-label">Portfolio</div>
        <a href="https://samrudhib-portfolio.web.app" class="contact-value" target="_blank" rel="noopener">samrudhib-portfolio.web.app</a>
      </div>
      <div class="contact-item">
